...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/billowing-lake-a38b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/billowing-lake-a38b
```

A live public deployment of this template is available at [https://billowing-lake-a38b.templates.workers.dev](https://billowing-lake-a38b.templates.workers.dev)
